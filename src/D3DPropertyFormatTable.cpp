        ...
        D3D_FORMAT_COMPONENT_INTERPRETATION* pInterpretations  ) // return array with 4 entries
{
    ...
    pInterpretations[0] = s_FormatDetail[Index].ComponentInterpretation0;
    pInterpretations[1] = s_FormatDetail[Index].ComponentInterpretation1;
    pInterpretations[2] = s_FormatDetail[Index].ComponentInterpretation2;
    pInterpretations[3] = s_FormatDetail[Index].ComponentInterpretation3;
}
...
{
    UINT NumComponents = min(GetNumComponentsInFormat(FormatA), GetNumComponentsInFormat(FormatB));
